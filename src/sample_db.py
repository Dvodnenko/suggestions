...
songs_db = [
    {
        ...
        "vector_x": np.array([0.395, 0.565, 0.001, 0.503, 0.625])
    },
    {
        ...
        "vector_x": np.array([0.627, 0.385, 0.287, 0.502, 0.362])
    },
    {
        ...
        "vector_x": np.array([0.413, 0.147, 0.865, 0.305, 0.197])
    },
    {
        ...
        "vector_x": np.array([0.551, 0.585, 0.027, 0.434, 0.450])
    }
]


quality_matrix = np.array([song["vector_x"] for song in songs_db])
